...
editUser({BuildContext? context, String? jabatan}) {
  final authC = Get.find<AuthController>();
  authC.displayNameController.text = authC.auth.currentUser!.displayName!;
  authC.jabatanController.text = authC.jabatan.value;
  authC.nipController.text = authC.nip.value;
